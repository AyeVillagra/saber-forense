  ...
  return (
    <div>
      ...
      <div className="about-container">
        ...
        <p>
          Saber Forense es una institución educativa dedicada a la formación en
          el área de la investigación criminal. Nuestros cursos están diseñados
          para proporcionar a los estudiantes las habilidades necesarias para
          enfrentar los desafíos en el campo de la criminología y la justicia
          penal.
        </p>
        <p>
